...
import com.zy.xxl.zyfiledownloader.download.filedownloader.FileDownloadConnectListener;
import com.zy.xxl.zyfiledownloader.download.filedownloader.FileDownloadListener;
import com.zy.xxl.zyfiledownloader.download.filedownloader.FileDownloadSampleListener;
...
//        FileDownloader.getImpl().pauseAll();
    ...
    private static class TaskItemAdapter extends RecyclerView.Adapter<TaskItemViewHolder> {
        ...
        public int getItemCount() {
            // FIXME: 2017/10/20 test
            int test = TasksManager.getImpl().getTaskCounts();
